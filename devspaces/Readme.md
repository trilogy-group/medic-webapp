...
```bash
devspaces start ds-medic
```

3 - Start containers synchronization

```bash
devspaces bind ds-medic
```

4 - Grab some container info

```bash
devspaces info ds-medic
```

5 - Connect to development container

```bash
devspaces exec ds-medic /bin/bash
```

6 - Configure MongoDB and build all

```bash
build_medic.sh
```
7 - After first build you can run only
```bash
yarn start
```